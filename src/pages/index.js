...
const faqs = [
  {
    id: 1,
    question: "Why would I want a forward?",
    answer:
      "A forward allows you to speculate on the future price of an asset or hedge without the uncertainty of perpetual funding rates.",
  },
  {
    id: 2,
    question: "How can I use the protocol?",
    answer:
      "There are two ways to use the protocol. The simplest is to buy an erc20 token on the secondary market, which gives you partial ownership of a forward position. At expiration you can use your token to claim your profit.",
  },
  {
    id: 3,
    question: "How can market makers create a new forward position?",
    answer:
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-4 lg:px-8">
          <div className="border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
              &copy; 2023 Protocol988. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
